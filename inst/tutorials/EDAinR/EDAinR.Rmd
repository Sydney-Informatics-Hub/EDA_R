...
destfile <- 'inst/tutorials/EDAinR/data/stack-overflow-developer-survey-2023.zip'
download.file(url, destfile, method = "curl")
zip_file <- here("inst/tutorials/EDAinR/data", "stack-overflow-developer-survey-2023.zip")
...
zip_file_schema <- here("inst/tutorials/EDAinR/data", "stack-overflow-developer-survey-2023.zip")
